 ...
 function resolverPrim(){
  ...
  return (
    ...
    <Grid item xs={2}>
      ...
      <Grid item xs={2}>
      <TextField id="standard-basic" label="Tiempo Generacion" variant="standard" onChange={(e)=>handleColumnas(e)} value={tiempo1}  InputProps={{
          endAdornment: <InputAdornment position="end">ms</InputAdornment>,
        }}/>
      </Grid>
      <Grid item xs={2}>
      <TextField  id="standard-basic" label="Tiempo Resolucion" variant="standard" onChange={(e)=>handleColumnas(e)} value={tiempo2} InputProps={{
          endAdornment: <InputAdornment position="end">ms</InputAdornment>,
        }}/>
      </Grid>
      <Grid item xs={2}>
      ...
      <Button style={{margin:"10px"}} variant="contained" onClick={resolver} disabled = {usado}>RESOLVER</Button>
      <Button style={{margin:"10px"}} variant="contained" onClick={resolverPrim} disabled = {usado}>PRIM</Button>
      </Grid>
      </Grid>
      ...
      grid.map( (lineas, index1)=>{
        ...
        {lineas.map(
            (columnas, index2)=>{
              return(
                columnas === "#" ?(
                    <span key={index2+"level2.2"}><img alt="" src={require('/Users/gabrieladiazr/Documents/GitHub/laberintos/src/Componentes/pared.png').default} width="5%"></img></span>
              
                ) :( columnas==="*" ?(
                  <span key={index2+"level2.2"}><img alt=""  src={require('/Users/gabrieladiazr/Documents/GitHub/laberintos/src/solucion.png').default} width="5%" ></img></span>)
                 :(
                  <span key={index2+"level2.2"}><img alt=""  src={require('/Users/gabrieladiazr/Documents/GitHub/laberintos/src/Componentes/camino.png').default} width="5%" ></img></span>)
                )
